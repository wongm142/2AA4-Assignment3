...
public class SpiralAlgorithum extends Algorithm {

    public SpiralAlgorithum(){
        super();
    }
    ...
    public boolean corner1(int i, Direction direction){
        switch (i) {
            case 0:
                this.action.heading(direction.rightDirection());
                break;
            case 1:
                this.action.fly();
                break;
            case 2:
                this.action.heading(direction.leftDirection());
                break;
            default:
                return false;
    ...
    private ArrayList<String> populateResponse(int state, int i, int revolution, Direction direction){ 
        ...
        response.add(direction.toString());
        return response;
    }
}
